...
public class EstablecerInterfazGrafica extends JFrame implements Observador, ActionListener {
    ...
    public EstablecerInterfazGrafica(Jugador jugador1, Jugador jugador2, Marcador marcador) {
        ...
        JLabel temporal = new JLabel(marcador.EstablecerMarcador(0, 0));
    ...
    public void update(Observable o) {
        if (o instanceof Pelota) {
            ...
            if (p.getEstado() instanceof PelotaAFuera) {
                ...
                String txt_marcador = this.marcador.EstablecerMarcador(jugador1.getPuntuacion(), jugador2.getPuntuacion());
